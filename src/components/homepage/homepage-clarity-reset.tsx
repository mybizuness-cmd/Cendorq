...
const SCAN_SIGNALS = [
  { label: "Clarity", detail: "Can customers understand what you do?", value: "92%" },
  { label: "Trust", detail: "Is enough proof visible?", value: "68%" },
  { label: "Choice", detail: "Can they compare you quickly?", value: "74%" },
  { label: "Action", detail: "Is the next step obvious?", value: "81%" },
] as const;
                ...
                {SCAN_SIGNALS.map((signal, index) => (
                  ...
                  >
                    ...
                    <div className="mt-4 h-2 overflow-hidden rounded-full bg-white/10">
                      <span
                        className="meter-line block h-full rounded-full bg-cyan-200"
                        style={{
                          width: signal.value,
