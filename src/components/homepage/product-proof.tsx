const ITEMS = [
  ["State", "Presence Report", "Show the report object early."],
  ["Gap", "Choice Gap", "Show why another option may be easier to choose."],
  ["Action", "Repair Queue", "Show the ranked path from weak signal to next action."],
  ["Watch", "Control Snapshot", "Show how public signals stay watched."],
] as const;
