      ...
      <section className="system-panel-authority relative z-10 overflow-hidden rounded-[1.65rem] p-4 shadow-[0_30px_120px_rgba(2,8,23,0.48)] sm:rounded-[1.85rem] sm:p-8">
        ...
        <div className="grid gap-5 lg:grid-cols-[1fr_20rem] lg:items-start">
          ...
          <div className="rounded-[1.25rem] border border-cyan-300/20 bg-cyan-300/10 p-4 sm:p-5">
            <div className="text-sm font-semibold text-cyan-100">Recommended next command</div>
            <h2 className="mt-2 text-2xl font-semibold tracking-tight text-white">Diagnose</h2>
            <p className="mt-3 text-sm leading-6 text-slate-200">Use Deep Review when the first signal matters enough that guessing is too expensive.</p>
