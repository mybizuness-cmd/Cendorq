...
export const metadata = buildMetadata({
  ...
  description: "Protected Cendorq Operations Index linking intake, entities, structured context, reputation, offers, pricing, billing, subscriptions, sources, queries, search surfaces, benchmarks, competitors, AI answers, reports, templates, delivery, PDF, email, attachments, support, plans, business truth, evidence, lineage, visuals, command queue, quality, agents, conversion, entitlements, integrations, analytics, and recovery.",
  path: "/dashboard/operations-index",
  noIndex: true,
});

const OPERATING_SURFACES = [
  ["Intake command", "/dashboard/intake-command", "Govern business facts, website context, plan routing, evidence permissions, uploads, and first-run state."],
  ["Entity command", "/dashboard/entity-command", "Govern identity, category, location, services, profiles, structured context, conflicts, recognition risk, and repair routes."],
  ["Structured context", "/dashboard/structured-context-command", "Govern schema, FAQ blocks, same-as links, service and location context, proof markup, validation, and repair routes."],
  ["Reputation command", "/dashboard/reputation-command", "Govern ratings, recency, themes, responses, testimonials, proof claims, trust gaps, and repair routes."],
  ["Offer command", "/dashboard/offer-command", "Govern services, packages, pricing context, guarantees, exclusions, buying path, conversion friction, and repair routes."],
  ["Pricing command", "/dashboard/pricing-command", "Govern plan prices, upgrade triggers, plan boundaries, proof-first CTAs, billing language, discounts, and conversion clarity."],
  ["Billing command", "/dashboard/billing-command", "Govern checkout, receipts, invoices, failed payments, refunds, disputes, entitlement sync, and billing recovery."],
  ["Subscription command", "/dashboard/subscription-command", "Govern renewals, cancellations, pauses, plan changes, proration context, entitlement transitions, and Control continuity."],
  ["Source command", "/dashboard/source-command", "Govern website pages, profiles, reviews, listings, search, AI-answer signals, freshness, conflicts, and source use."],
  ["Query command", "/dashboard/query-command", "Govern customer questions, search intent, local prompts, comparison prompts, AI prompts, evidence, and plan-safe language."],
  ["Search surface command", "/dashboard/search-surface-command", "Govern result snippets, local visibility, business profile signals, answer surfaces, AI pressure, reviews, and repair routes."],
  ["AI answer command", "/dashboard/ai-answer-command", "Govern prompts, entity clarity, answer readiness, citation context, hallucination risk, and safe report language."],
  ["Benchmark command", "/dashboard/benchmark-command", "Govern category context, public proof, AI visibility pressure, comparison visuals, uncertainty, and benchmark-safe decisions."],
  ["Competitor command", "/dashboard/competitor-command", "Govern peer sets, public proof gaps, positioning pressure, AI-answer contrast, visuals, and uncertainty-safe comparisons."],
  ["Report vault", "/dashboard/reports", "Open Scan, Review, Repair, and Control artifacts from one protected vault."],
  ["Template command", "/dashboard/template-command", "Govern dashboard modules, PDF sections, email summaries, support packets, snapshots, and completion artifacts."],
  ...
  ["PDF command", "/dashboard/pdf-command", "Govern executive-ready PDFs, visual readiness, approved source packages, downloads, and render recovery."],
  ["Email command", "/dashboard/email-command", "Keep report summaries, secure routes, resend state, support updates, and recovery emails aligned."],
  ["Attachment command", "/dashboard/attachment-command", "Govern customer-safe files, support uploads, downloads, evidence references, versions, and recovery."],
...
const INDEX_RULES = [
  ...
  "No protected surface should imply delivery, approval, repair, conversion, comparison, AI-answer certainty, query certainty, search placement, entity recognition, machine-readable authority, reputation proof, offer truth, pricing truth, billing truth, subscription truth, or access before its state is ready.",
  "Intake, entities, structured context, reputation, offers, pricing, billing, subscriptions, sources, queries, search surfaces, benchmarks, competitors, AI answers, reports, templates, delivery, PDF, email, attachments, support, plans, evidence, lineage, visuals, quality, agents, conversion, and analytics should stay connected rather than becoming separate silos.",
  "The customer dashboard should remain clear even as the operating system grows deeper.",
] as const;

const SYSTEM_GROUPS = [
  ["Customer value", "Intake, entities, structured context, reputation, offers, pricing, billing, subscriptions, sources, queries, search surfaces, benchmarks, competitors, AI answers, reports, templates, delivery, PDF, email, attachments, support, conversion, and next commands."],
  ["Truth and proof", "Business facts, entity context, structured context, reputation context, offer context, pricing context, billing context, subscription context, source context, query context, search context, benchmark context, competitor context, AI-answer context, evidence, lineage, visuals, quality, and release approval."],
    ...
    <main className="relative isolate min-h-screen overflow-hidden bg-[radial-gradient(circle_at_10%_0%,rgba(125,211,252,.28),transparent_30%),radial-gradient(circle_at_86%_0%,rgba(196,181,253,.2),transparent_34%),linear-gradient(180deg,#ffffff_0%,#eefbff_42%,#ffffff_100%)] px-4 py-14 text-slate-950 sm:px-6">
      ...
      <section className="mx-auto grid max-w-[94rem] gap-6 lg:grid-cols-[0.82fr_1.18fr] lg:items-stretch">
        <div className="rounded-[2.25rem] border border-white/80 bg-white/84 p-6 shadow-[0_24px_80px_rgba(15,23,42,.065)] backdrop-blur sm:p-8">
          ...
          <p className="mt-6 text-base font-semibold leading-8 text-slate-600">The Operations Index connects every protected surface added to the dashboard so intake, entities, structured context, reputation, offers, pricing, billing, subscriptions, sources, queries, search surfaces, benchmarks, competitors, AI answers, reports, templates, delivery, PDF, email, attachments, support, plans, proof, workflows, analytics, conversion, agents, and recovery remain navigable and governed.</p>
          <div className="mt-8 flex flex-col gap-3 sm:flex-row">
            ...
            <Link href="/dashboard/subscription-command" className="rounded-full border border-cyan-200 bg-white px-5 py-3 text-center text-sm font-bold text-cyan-700">Open Subscription Command</Link>
          </div>
        </div>
      ...
      <section className="sr-only" aria-label="Operations index guardrails">Operations Index. Intake command. Entity command. Structured Context Command. Reputation command. Offer command. Pricing command. Billing command. Subscription command. Source command. Query command. Search surface command. AI answer command. Benchmark command. Competitor command. Report vault. Template command. Delivery history. PDF command. Email command. Attachment command. Release gate. Quality gate. Plan matrix. Agent doctrine. Conversion command. Repair workroom. Control center. Support center. Business Truth. Evidence catalog. Report lineage. Visual registry. Command queue. Customer Command Profile. Entitlement center. Integration registry. Analytics center. Audit recovery. Protected customer operating system.</section>
    </main>
  );
}
