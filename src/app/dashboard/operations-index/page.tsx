...
export const metadata = buildMetadata({
  ...
  description: "Protected Cendorq Operations Index linking intake, entities, structured context, reputation, offers, pricing, billing, sources, queries, search surfaces, benchmarks, competitors, AI answers, reports, templates, delivery, PDF, email, attachments, support, plans, business truth, evidence, lineage, visuals, command queue, quality, agents, conversion, entitlements, integrations, analytics, and recovery.",
...
const INDEX_RULES = [
  ...
  "No protected surface should imply delivery, approval, repair, conversion, comparison, AI-answer certainty, query certainty, search placement, entity recognition, machine-readable authority, reputation proof, offer truth, pricing truth, billing truth, or access before its state is ready.",
  "Intake, entities, structured context, reputation, offers, pricing, billing, sources, queries, search surfaces, benchmarks, competitors, AI answers, reports, templates, delivery, PDF, email, attachments, support, plans, evidence, lineage, visuals, quality, agents, conversion, and analytics should stay connected rather than becoming separate silos.",
  "The customer dashboard should remain clear even as the operating system grows deeper.",
] as const;

const SYSTEM_GROUPS = [
  ["Customer value", "Intake, entities, structured context, reputation, offers, pricing, billing, sources, queries, search surfaces, benchmarks, competitors, AI answers, reports, templates, delivery, PDF, email, attachments, support, conversion, and next commands."],
  ["Truth and proof", "Business facts, entity context, structured context, reputation context, offer context, pricing context, billing context, source context, query context, search context, benchmark context, competitor context, AI-answer context, evidence, lineage, visuals, quality, and release approval."],
      ...
      <section className="mx-auto grid max-w-[94rem] gap-6 lg:grid-cols-[0.82fr_1.18fr] lg:items-stretch">
        <div className="rounded-[2.25rem] border border-white/80 bg-white/84 p-6 shadow-[0_24px_80px_rgba(15,23,42,.065)] backdrop-blur sm:p-8">
          ...
          <div className="mt-8 flex flex-col gap-3 sm:flex-row">
            ...
            <Link href="/dashboard/billing-command" className="rounded-full border border-cyan-200 bg-white px-5 py-3 text-center text-sm font-bold text-cyan-700">Open Billing Command</Link>
          </div>
        </div>
