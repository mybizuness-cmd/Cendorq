...
const PRIORITY_FEED = [
  ...
  },
  {
    planKey: "deep-review",
    command: "Review",
    moment: "Cause needs evidence",
    value: "Move from first signal into review when guessing would be expensive.",
  ...
  },
  {
    ...
    value: "Keep readiness, trust, friction, and monthly decisions under review.",
...
const ALERT_TYPES = [
  { title: "Readiness proof", copy: "Open the exact report record before making a paid decision.", href: "/dashboard/reports" },
