...
const SUPPORT_ROUTES = [
  ...
  },
  {
    ...
    value: "Clarify confidence, limits, evidence boundaries, and next-step logic.",
    boundary: "A Free Scan question does not become a full AI Readiness Review unless unlocked.",
  },
  {
    key: "scope-question",
    label: "Repair scope",
