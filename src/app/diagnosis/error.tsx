...
const recoveryRoutes = [
    {
        title: "Retry the explanation route",
        copy:
            "Use this first if the interruption looks temporary and you want the system-path page to attempt a clean recovery.",
        type: "retry" as const,
    },
    {
        title: "Return to the Search Presence Scan",
        copy:
            "Use this if you want to go back to the strongest first step instead of forcing the explanation route while it is unstable.",
        href: "/free-check",
    ...
    },
    {
        ...
        copy:
            "Use this if you want to re-enter the full system from the main route and choose the next path again from a stable page.",
        href: "/",
        label: "Return home",
    },
];

export default function DiagnosisErrorPage({
    error,
    reset,
}: DiagnosisErrorPageProps) {
    useEffect(() => {
        ...
        <main className="relative mx-auto max-w-7xl overflow-hidden px-4 py-12 text-white sm:px-6 md:py-16 xl:py-20">
            ...
            <section className="relative z-10 max-w-5xl">
                ...
                <p className="mt-6 max-w-4xl text-base leading-8 text-slate-300 sm:text-lg">
                    The system-path page failed while trying to load or render the
                    explanation layer. That does not automatically mean the whole platform
                    is down. It means this specific route needs a clean retry or a cleaner
                    re-entry path.
                </p>
                ...
                <div className="mt-8 flex flex-wrap gap-3">
                    ...
                    <AuthorityPill>Do not force a broken page</AuthorityPill>
                </div>
            </section>
            ...
            <section className="relative z-10 mt-16 grid gap-6 lg:grid-cols-[1.02fr_0.98fr]">
                <div className="system-panel-authority rounded-[2rem] p-6 sm:p-8 md:p-10">
                    ...
                    <h2 className="mt-5 max-w-4xl text-3xl font-semibold tracking-tight text-white sm:text-4xl md:text-5xl">
                        The page that explains the system sequence broke before the path could be read cleanly.
                    </h2>

                    <p className="mt-6 max-w-3xl text-base leading-8 text-slate-300">
                        This route matters because it explains why the system starts with
                        signal, moves into deeper explanation only when justified, and then
                        points the business toward the right paid layer. When this page
                        breaks, the right move is not random clicking. The right move is
                        controlled recovery.
                    </p>

                    <p className="mt-5 max-w-3xl text-base leading-8 text-slate-300">
                        Retry the route once. If it still fails, go back into a stable path
                        and re-enter through the Search Presence Scan or the homepage so the system
                        stays readable and authoritative instead of chaotic.
                    </p>

                    <div className="mt-8 grid gap-4 sm:grid-cols-3">
                        <StatusTile label="Signal path" value="Still available" />
                        <StatusTile label="Explanation layer" value="Interrupted" highlighted />
                ...
                <div className="grid gap-4">
                    <ReadoutCard
                        label="Route state"
                        value="System-path failure captured"
                        copy="The interruption happened on the explanation route, not necessarily across the full application."
                    />
                    <ReadoutCard
                        label="Best next move"
                        value="Retry once, then use a stronger route"
                        copy="If the route does not recover immediately, go back to a stable entry point instead of forcing the broken page."
                    />
                    <ReadoutCard
                        label="Reference"
                        value={reference}
                ...
                <div className="system-panel-authority rounded-[2rem] p-6 sm:p-8 md:p-10">
                    <div className="grid gap-8 lg:grid-cols-[1.08fr_0.92fr] lg:items-center">
                        <div>
                            ...
                            <h2 className="mt-5 max-w-4xl text-3xl font-semibold tracking-tight text-white sm:text-4xl md:text-5xl">
                                Do not decide the next step from a broken explanation page.
                            </h2>

                            <p className="mt-6 max-w-3xl text-base leading-8 text-slate-300">
                                The stronger move is to recover the route once, then step back
                                into a stable path if needed. That keeps the system sequence
                                clear instead of letting a temporary page failure distort the
                                next decision.
                            </p>
                        ...
                        <div className="grid gap-4">
                            ...
                            <InfoTile label="System reset route" value="Homepage" />
...
function DiagnosisErrorAtmosphere() {
    return (
