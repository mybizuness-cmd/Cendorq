...
export default function HomePage() {
  return (
    <main data-cendorq-homepage="cinematic-ai-readiness-experience" className={CENDORQ_EXPERIENCE_SYSTEM.pageShell}>
      <section className="relative overflow-hidden px-5 pb-16 pt-10 sm:px-8 lg:min-h-[calc(100vh-4.25rem)] lg:pb-20 lg:pt-16">
        ...
        <div className="relative mx-auto grid w-full max-w-7xl gap-8 lg:grid-cols-[minmax(0,1.02fr)_minmax(28rem,0.98fr)] lg:items-center">
          <div className="max-w-[48rem] text-left">
            <p className={CENDORQ_EXPERIENCE_SYSTEM.eyebrow}>
              AI Engine Readiness
            </p>
            <h1 className="mt-6 text-[clamp(3.4rem,6.25vw,6.35rem)] font-semibold leading-[0.88] tracking-[-0.084em] text-slate-950">
          ...
          <div className="relative mx-auto w-full max-w-[40rem] lg:ml-auto" aria-hidden="true">
            ...
            <div className="relative rounded-[3rem] border border-white/90 bg-white/72 p-3 shadow-[0_40px_140px_rgba(15,23,42,0.18)] backdrop-blur-2xl">
              <div className="overflow-hidden rounded-[2.35rem] border border-slate-200 bg-[linear-gradient(145deg,#ffffff,#f2fbff_58%,#ffffff)] p-6 shadow-inner sm:p-8">
                <div className="flex items-start justify-between gap-4">
                  <div>
                    <p className="text-xs font-bold uppercase tracking-[0.24em] text-slate-500">First signal</p>
                    <h2 className="mt-3 text-[clamp(2.25rem,4vw,4rem)] font-semibold leading-[0.95] tracking-[-0.07em] text-slate-950">Can they choose you?</h2>
                  </div>
                ...
                <div className="mt-8 grid gap-4 sm:grid-cols-2">
                  {CENDORQ_SIGNAL_WORDS.map((signal, index) => (
                    <div key={signal} className="rounded-[1.35rem] border border-slate-200 bg-white/88 p-4 shadow-[0_12px_35px_rgba(15,23,42,0.06)]">
                ...
                <div className="mt-5 rounded-[1.65rem] border border-slate-800 bg-[linear-gradient(135deg,#020617,#172554_68%,#083344)] p-5 text-white shadow-[0_20px_60px_rgba(15,23,42,0.24)]">
                  ...
                  <p className="mt-3 text-sm font-medium leading-6 text-slate-200">One clear path from first signal to stronger readiness.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className={`relative ${CENDORQ_EXPERIENCE_SYSTEM.maxWidth}`}>
          <div className="mb-8 grid gap-6 lg:grid-cols-[1fr_auto] lg:items-end">
            <div>
              ...
              <h2 className="mt-3 max-w-4xl text-[clamp(2.75rem,5vw,5.4rem)] font-semibold leading-[0.95] tracking-[-0.075em] text-slate-950">Start with the first signal. Move deeper only when it makes sense.</h2>
            </div>
