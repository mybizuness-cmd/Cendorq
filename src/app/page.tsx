      ...
      <section className="relative px-5 py-10 sm:px-8 lg:py-16" aria-label="Free Scan invitation">
        ...
        <div className="relative mx-auto max-w-5xl rounded-[2rem] border border-white/80 bg-[linear-gradient(180deg,rgba(255,255,255,0.9),rgba(234,250,255,0.86))] p-6 shadow-[0_24px_85px_rgba(15,23,42,0.075)] backdrop-blur sm:rounded-[2.6rem] sm:p-8 lg:p-10">
          ...
          <p className="mt-5 max-w-3xl text-base font-medium leading-8 text-slate-600 sm:text-lg">
            The homepage should point to one calm first action. The deeper plan path stays on Plans, where it belongs.
          </p>
          <div className="mt-7 flex flex-col gap-3 sm:flex-row">
            <Link href="/free-check" className={CENDORQ_EXPERIENCE_SYSTEM.primaryButton}>Start Free Scan</Link>
            <Link href="/plans" className={CENDORQ_EXPERIENCE_SYSTEM.secondaryButton}>Compare plans</Link>
          </div>
        </div>
      </section>

      <section className="sr-only" aria-label="Cendorq homepage verification">
        Cendorq homepage replacement. Restored compact circular signal map. No customer path block. No repeated homepage plan cards. Blue cyan atmosphere through homepage body. Start with the first signal. Move deeper only when it makes sense. Start Free Scan. Compare plans. No AI placement promises. Unified Cendorq Experience System. {CENDORQ_EXPERIENCE_GUARDRAILS.join(" ")}
      </section>
    </main>
  );
}
