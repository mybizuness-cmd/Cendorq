...
const recoveryRoutes = [
    {
        title: "Retry the privacy page",
        copy:
            "Use this first if the interruption looks temporary and you want the privacy route to attempt a clean recovery.",
        type: "retry" as const,
    },
    {
        title: "Return to Contact",
        copy:
            "Use this if you need a stable route for privacy-related questions while the privacy page is unavailable.",
        href: "/contact",
        label: "Go to contact",
    },
    {
        title: "Go back to Terms",
        copy:
            "Use this if you want to step back into the legal and trust layer through a stable route instead of forcing the broken page.",
        href: "/terms",
        label: "Read terms",
    },
];
        ...
        <main className="relative mx-auto max-w-7xl overflow-hidden px-4 py-12 text-white sm:px-6 md:py-16 xl:py-20">
            ...
            <section className="relative z-10 max-w-5xl">
                ...
                <p className="mt-6 max-w-4xl text-base leading-8 text-slate-300 sm:text-lg">
                    The privacy page failed while trying to load or render the trust and
                    data-boundary layer. That does not automatically mean the whole
                    platform is down. It means this specific route needs a clean retry or
                    a cleaner re-entry path.
                </p>

                <div className="mt-8 flex flex-wrap gap-3">
                    <AuthorityPill>Retry once</AuthorityPill>
                    <AuthorityPill>Protect trust clarity</AuthorityPill>
            ...
            <section className="relative z-10 mt-16 grid gap-6 lg:grid-cols-[1.02fr_0.98fr]">
                <div className="system-panel-authority rounded-[2rem] p-6 sm:p-8 md:p-10">
                    ...
                    <h2 className="mt-5 max-w-4xl text-3xl font-semibold tracking-tight text-white sm:text-4xl md:text-5xl">
                        The page that should clarify data purpose and trust boundaries broke
                        before it could load cleanly.
                    </h2>

                    <p className="mt-6 max-w-3xl text-base leading-8 text-slate-300">
                        This route matters because privacy pages shape trust. They help
                        businesses understand what information may be collected, why it may
                        be used, and where the boundaries should sit. When that route fails,
                        the right move is not random clicking. The right move is controlled
                        recovery.
                    </p>

                    <p className="mt-5 max-w-3xl text-base leading-8 text-slate-300">
                        Retry the page once. If it still fails, step back into Contact or
                        Terms so the business can recover clarity from a stable route rather
                        than forcing a broken trust page.
                    </p>

                    <div className="mt-8 grid gap-4 sm:grid-cols-3">
                        <StatusTile label="Trust layer" value="Still available elsewhere" />
                        <StatusTile label="Privacy page" value="Interrupted" highlighted />
                ...
                <div className="grid gap-4">
                    <ReadoutCard
                        label="Route state"
                        value="Privacy route failure captured"
                        copy="The interruption happened on the privacy page, not necessarily across the full system."
                    />
                    <ReadoutCard
                        label="Best next move"
                        value="Retry once, then step back cleanly"
                        copy="If the page does not recover immediately, use Contact or Terms instead of forcing a broken privacy route."
                    />
                    <ReadoutCard
                        label="Reference"
                        value={reference}
            ...
            <section className="relative z-10 mt-20">
                <div className="max-w-3xl">
                    ...
                    <h2 className="mt-4 text-3xl font-semibold tracking-tight text-white sm:text-4xl md:text-5xl">
                        Use the cleanest route back into the trust layer.
                    </h2>
                </div>
                ...
                <div className="system-panel-authority rounded-[2rem] p-6 sm:p-8 md:p-10">
                    <div className="grid gap-8 lg:grid-cols-[1.08fr_0.92fr] lg:items-center">
                        <div>
                            ...
                            <h2 className="mt-5 max-w-4xl text-3xl font-semibold tracking-tight text-white sm:text-4xl md:text-5xl">
                                Do not let a broken privacy page distort the trust message.
                            </h2>

                            <p className="mt-6 max-w-3xl text-base leading-8 text-slate-300">
                                The stronger move is to recover the route once, then step back
                                into a stable trust path if needed. That keeps the system clear,
                                controlled, and credible instead of letting a temporary page
                                failure weaken the trust layer.
                            </p>
                        ...
                        <div className="grid gap-4">
                            <InfoTile label="Most stable re-entry" value="Contact" />
                            <InfoTile label="Fallback legal route" value="Terms" />
...
function PrivacyErrorAtmosphere() {
    return (
