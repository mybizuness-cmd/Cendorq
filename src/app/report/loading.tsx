  ...
  return (
    <main className="relative mx-auto max-w-7xl overflow-hidden px-4 py-12 text-white sm:px-6 md:py-16 xl:py-20">
      <section className="system-panel-authority rounded-[2rem] p-8 text-center">
        ...
        <p className="mx-auto mt-6 max-w-2xl text-base leading-8 text-slate-300">Cendorq is resolving the latest Free Scan snapshot, route recommendation, and explanation trace for this business.</p>
      </section>
    </main>
  );
}
