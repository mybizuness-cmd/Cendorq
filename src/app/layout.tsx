...
const KNOWLEDGE_AREAS = [
  ...
  "Answer-ready business presence",
  "Free Scan",
  "Deep Review",
  "Build Fix",
  "Ongoing Control",
...
const LAYER_CATALOG = [
  {
    name: "Scan",
    path: "/free-check",
    description: "First-read scan that helps a business see where AI systems and customers may fail to find, understand, trust, compare, or choose it.",
  },
  {
    name: "Review",
    path: "/plans/deep-review",
    description: "Cause-level Deep Review of the signals weakening business clarity, proof, visibility, trust, and customer choice.",
  },
  {
    name: "Repair",
    path: "/plans/build-fix",
    description: "Focused Build Fix for the clearest weak point after evidence shows what should be repaired first.",
  },
  {
    name: "Control",
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    title: `${siteConfig.name} — AI Search Presence Repair`,
    description: siteConfig.description,
    locale: "en_US",
    images: [{ url: "/opengraph-image", width: 1200, height: 630, alt: `${siteConfig.name} — AI Search Presence Repair` }],
  },
  twitter: { card: "summary_large_image", title: `${siteConfig.name} — AI Search Presence Repair`, description: siteConfig.description, images: ["/twitter-image"] },
  robots: {
    index: true,
    follow: true,
...
function buildStructuredData() {
  ...
  const service = {
    ...
    "@id": SERVICE_ID,
    name: `${BRAND_NAME} AI Search Presence Repair`,
    url: siteConfig.siteUrl,
    description: siteConfig.description,
