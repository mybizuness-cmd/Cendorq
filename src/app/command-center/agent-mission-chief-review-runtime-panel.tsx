...
const CHIEF_REVIEW_SAMPLE_BY_PLAN = {
  "free-scan": {
    ...
    consolidatedFacts: ["The Free Scan mission must stay a first visible signal, not a full review."],
    priorityFindings: ["Show one strongest observed issue and one safe next action."],
    evidenceConflicts: ["No full review evidence has been reviewed yet."],
    safeLimitations: ["Do not imply implementation, full review, or certain revenue results."],
  ...
  "deep-review": {
    ...
    priorityFindings: ["Prioritize cause-level review before Build Fix recommendation."],
