...
const SAMPLE_FINDING_BY_PLAN = {
  "free-scan": {
    ...
    evidenceGaps: ["No full review evidence has been collected."],
    ...
    blockedCustomerClaims: ["full review", "certain revenue results", "implementation included"],
  },
  "deep-review": {
    agentKey: "evidence-conflict-scout",
    verifiedFacts: ["The mission requires cause-level review before fix recommendations."],
