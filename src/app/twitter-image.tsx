...
export const alt =
  "Cendorq — AI market command for businesses that need customers, search, maps, reviews, and AI answers to understand, trust, and choose them.";
...
const strategicPillars = ["AI/search clarity", "Market proof", "Clear next command"] as const;

const readouts = [
  { label: "First signal", value: "Free Scan" },
  { label: "Cause proof", value: "Deep Review" },
  { label: "Focused fix", value: "Build Fix" },
  { label: "Continued watch", value: "Ongoing Control" },
] as const;
            ...
            <div style={{ display: "flex", flexDirection: "column" }}>
              <div style={{ display: "flex", alignItems: "center", alignSelf: "flex-start", gap: 14, padding: "10px 14px 10px 10px", borderRadius: 999, border: "1px solid rgba(255,255,255,0.1)", background: "linear-gradient(180deg, rgba(255,255,255,0.06), rgba(255,255,255,0.03))", boxShadow: "0 14px 34px rgba(2,8,23,0.22)" }}>
                ...
                <div style={{ display: "flex", flexDirection: "column" }}>
                  ...
                  <div style={{ fontSize: 11, fontWeight: 700, letterSpacing: "0.18em", textTransform: "uppercase", color: "#94a3b8" }}>AI Market Command</div>
                </div>
              </div>
              ...
              <div style={{ marginTop: 22, display: "flex", flexDirection: "column", maxWidth: 720 }}>
                <div style={{ fontSize: 62, lineHeight: 0.94, fontWeight: 800, letterSpacing: "-0.055em", color: "#f8fafc" }}>
                  Win understanding
                </div>
              ...
              <div style={{ marginTop: 22, maxWidth: 720, fontSize: 22, lineHeight: 1.5, color: "#cbd5e1" }}>
                Make the business clearer to customers, search, maps, reviews, and AI answers before spending more on the wrong fix.
              </div>
            </div>
          ...
          <div style={{ width: 324, display: "flex", flexDirection: "column", gap: 14 }}>
            <div style={{ display: "flex", flexDirection: "column", borderRadius: 30, border: "1px solid rgba(255,255,255,0.09)", background: "linear-gradient(180deg, rgba(9,18,34,0.92), rgba(6,13,26,0.86))", padding: "20px 20px 18px", boxShadow: "0 1px 0 rgba(255,255,255,0.04) inset, 0 28px 80px rgba(0,0,0,0.36)" }}>
              ...
              <div style={{ marginTop: 14, fontSize: 15, lineHeight: 1.58, color: "#cbd5e1" }}>
                Keep the path clear so the customer knows what matters now and what comes next.
              </div>
