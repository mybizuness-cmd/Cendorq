...
export const alt =
    "Cendorq — Search Presence OS for businesses that need to become and remain the strongest answer across evolving search.";
            ...
            >
                ...
                <div
                    style={{
                        ...
                        opacity: 0.2,
                        background:
                            "linear-gradient(90deg, transparent 0%, rgba(103,232,249,0.24) 18%, rgba(255,255,255,0.12) 50%, rgba(103,232,249,0.24) 82%, transparent 100%)",
                    }}
                />
                ...
                <div
                    style={{
                        ...
                        opacity: 0.18,
                        background:
                            "linear-gradient(90deg, transparent 0%, rgba(103,232,249,0.2) 18%, rgba(255,255,255,0.1) 50%, rgba(103,232,249,0.2) 82%, transparent 100%)",
                    }}
                />
                ...
                >
                    ...
                    >
                        <div style={{ display: "flex", flexDirection: "column" }}>
                            ...
                            >
                                <div
                                    style={{
                                        ...
                                        background:
                                            "radial-gradient(circle at 30% 30%, rgba(103,232,249,0.22), transparent 55%), #08111f",
                                    }}
                                >
                                    <div
                                        style={{
                            ...
                            >
                                ...
                                infrastructure, and recurring command so they can become and
                                remain the answer customers and search systems trust first.
                            </div>
                        </div>
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                Read the business before prescribing stronger pressure.
                            </div>
                            ...
                            >
                                The path starts with signal, deepens into explanation, then
                                routes the business into the right one-time or recurring layer.
                            </div>
