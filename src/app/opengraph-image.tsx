...
const readouts = [
  ...
  { label: "Focused work", value: "Build Fix" },
  { label: "Monthly watch", value: "Ongoing Control" },
] as const;

const operatingPillars = ["AI/search clarity", "Market proof", "Next command"] as const;
        ...
        <div style={{ position: "relative", display: "flex", width: "100%", height: "100%", padding: "42px 42px 40px", gap: 26 }}>
          <div style={{ display: "flex", flexDirection: "column", justifyContent: "space-between", flex: 1, minWidth: 0 }}>
            <div style={{ display: "flex", flexDirection: "column" }}>
              ...
              <div style={{ marginTop: 26, display: "flex", flexDirection: "column", maxWidth: 760 }}>
              ...
              <div style={{ marginTop: 24, maxWidth: 750, fontSize: 23, lineHeight: 1.52, color: "#cbd5e1" }}>
                Cendorq helps businesses become clearer to customers, search, maps, reviews, and AI answers before money is spent on the wrong fix.
              </div>
            </div>
          ...
          <div style={{ width: 338, display: "flex", flexDirection: "column", gap: 16 }}>
            <div style={{ display: "flex", flexDirection: "column", borderRadius: 34, border: "1px solid rgba(255,255,255,0.09)", background: "linear-gradient(180deg, rgba(9,18,34,0.92), rgba(6,13,26,0.86))", padding: "22px 22px 20px", boxShadow: "0 1px 0 rgba(255,255,255,0.04) inset, 0 28px 80px rgba(0,0,0,0.36)" }}>
              ...
              <div style={{ marginTop: 16, fontSize: 16, lineHeight: 1.58, color: "#cbd5e1" }}>
                Find the first signal. Prove the cause. Improve the weak point. Keep watch as search and customers move.
              </div>
