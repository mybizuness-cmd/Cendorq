...
type MonthlyPartnerErrorPageProps = {
...
const recoveryRoutes = [
    {
        title: "Retry the Presence Command page",
        copy:
            "Use this first if the interruption looks temporary and you want the recurring continuity route to attempt a clean recovery.",
        type: "retry" as const,
    },
    {
        title: "Return to Visibility Blueprint",
        copy:
            "Use this if you want to step back into the explanation layer before trying to enter the continuity page again.",
        href: "/pricing/full-diagnosis",
        label: "View Visibility Blueprint",
    },
    {
        title: "Compare all plans",
        copy:
            "Use this if you want to step back into the broader plan architecture and re-evaluate the strongest next move from a stable route.",
        href: "/pricing",
        label: "View plans",
    },
];

export default function MonthlyPartnerErrorPage({
    error,
    reset,
}: MonthlyPartnerErrorPageProps) {
    useEffect(() => {
        console.error("Presence Command route error:", error);
    }, [error]);
        ...
        <main className="relative mx-auto max-w-7xl overflow-hidden px-4 py-12 text-white sm:px-6 md:py-16 xl:py-20">
            ...
            <section className="relative z-10 max-w-5xl">
                ...
                <p className="mt-6 max-w-4xl text-base leading-8 text-slate-300 sm:text-lg">
                    The Presence Command page failed while trying to load or render the
                    recurring strategic support layer. That does not automatically mean the
                    full platform is down. It means this specific route needs a clean retry
                    or a cleaner re-entry path.
                </p>

                <div className="mt-8 flex flex-wrap gap-3">
                    <AuthorityPill>Retry once</AuthorityPill>
                    <AuthorityPill>Protect continuity logic</AuthorityPill>
            ...
            <section className="relative z-10 mt-16 grid gap-6 lg:grid-cols-[1.02fr_0.98fr]">
                <div className="system-panel-authority rounded-[2rem] p-6 sm:p-8 md:p-10">
                    ...
                    <h2 className="mt-5 max-w-4xl text-3xl font-semibold tracking-tight text-white sm:text-4xl md:text-5xl">
                        The page that should move the business into recurring strategic
                        continuity broke before it could load cleanly.
                    </h2>

                    <p className="mt-6 max-w-3xl text-base leading-8 text-slate-300">
                        This route matters because it is where the business moves beyond a
                        one-time answer and into a steadier monthly support structure. When
                        this page fails, the right move is not more random clicking. The
                        right move is controlled recovery.
                    </p>

                    <p className="mt-5 max-w-3xl text-base leading-8 text-slate-300">
                        Retry the page once. If it still fails, step back into the diagnosis
                        layer or the main plans route so the business does not confuse a
                        temporary route failure with the actual next-step decision.
                    </p>

                    <div className="mt-8 grid gap-4 sm:grid-cols-3">
                        <StatusTile label="Explanation layer" value="Still available" />
                        <StatusTile
                ...
                <div className="grid gap-4">
                    <ReadoutCard
                        label="Route state"
                        value="Presence Command route failure captured"
                        copy="The interruption happened on the recurring continuity page, not necessarily across the full system."
                    />
                    <ReadoutCard
                        label="Best next move"
                        value="Retry once, then step back cleanly"
                        copy="If the page does not recover immediately, return to Visibility Blueprint or Plans instead of forcing a broken continuity layer."
                    />
                    <ReadoutCard
                        label="Reference"
                        value={reference}
            ...
            <section className="relative z-10 mt-20">
                <div className="max-w-3xl">
                    ...
                    <h2 className="mt-4 text-3xl font-semibold tracking-tight text-white sm:text-4xl md:text-5xl">
                        Use the cleanest route back into the continuity path.
                    </h2>
                </div>
                ...
                <div className="system-panel-authority rounded-[2rem] p-6 sm:p-8 md:p-10">
                    <div className="grid gap-8 lg:grid-cols-[1.08fr_0.92fr] lg:items-center">
                        <div>
                            ...
                            <h2 className="mt-5 max-w-4xl text-3xl font-semibold tracking-tight text-white sm:text-4xl md:text-5xl">
                                Do not make the continuity decision from a broken monthly-support page.
                            </h2>

                            <p className="mt-6 max-w-3xl text-base leading-8 text-slate-300">
                                The stronger move is to recover the page once, then step back
                                into Visibility Blueprint or the broader plans route if needed. That
                                keeps the sequence clean and protects the business from taking a
                                longer-range step through a broken or unstable layer.
                            </p>
                        ...
                        <div className="grid gap-4">
                            <InfoTile label="Most stable re-entry" value="Visibility Blueprint" />
...
function MonthlyPartnerErrorAtmosphere() {
    return (
        <div className="pointer-events-none absolute inset-0 overflow-hidden">
            <div className="absolute -left-10 top-8 h-72 w-72 rounded-full bg-emerald-400/10 blur-3xl sm:h-96 sm:w-96" />
