...
type OptimizationErrorPageProps = {
...
const recoveryRoutes = [
    {
        title: "Retry the Presence Infrastructure page",
        copy:
            "Use this first if the interruption looks temporary and you want the one-time improvement route to attempt a clean recovery.",
        type: "retry" as const,
    },
    {
        title: "Return to Visibility Blueprint",
        copy:
            "Use this if you want to step back into the explanation layer before trying to enter the Presence Infrastructure page again.",
    ...
    },
    {
        ...
        copy:
            "Use this if you want to step back into the full plan architecture and re-evaluate the strongest next move from a stable route.",
        href: "/pricing",
        label: "View plans",
    },
];
...
export default function OptimizationErrorPage({
    error,
    reset,
}: OptimizationErrorPageProps) {
    useEffect(() => {
        console.error("Presence Infrastructure route error:", error);
    }, [error]);
        ...
        <main className="relative mx-auto max-w-7xl overflow-hidden px-4 py-12 text-white sm:px-6 md:py-16 xl:py-20">
            ...
            <section className="relative z-10 max-w-5xl">
                ...
                <p className="mt-6 max-w-4xl text-base leading-8 text-slate-300 sm:text-lg">
                    The Presence Infrastructure page failed while trying to load or render the
                    one-time improvement layer. That does not automatically mean the full
                    platform is down. It means this specific route needs a clean retry or a
            ...
            <section className="relative z-10 mt-16 grid gap-6 lg:grid-cols-[1.02fr_0.98fr]">
                <div className="system-panel-authority rounded-[2rem] p-6 sm:p-8 md:p-10">
                    ...
                    <h2 className="mt-5 max-w-4xl text-3xl font-semibold tracking-tight text-white sm:text-4xl md:text-5xl">
                        The page that should translate explanation into focused improvement
                        broke before it could load cleanly.
                    </h2>

                    <p className="mt-6 max-w-3xl text-base leading-8 text-slate-300">
                        This route matters because it is where the business moves from
                        knowing what appears weak into a more concentrated one-time effort
                        to improve the highest-priority issues. When this page fails, the
                        right move is not more random clicking. The right move is controlled
                        recovery.
                    </p>
                    ...
                    <div className="mt-8 grid gap-4 sm:grid-cols-3">
                        ...
                        <StatusTile label="Presence Infrastructure layer" value="Interrupted" highlighted />
                ...
                <div className="grid gap-4">
                    <ReadoutCard
                        label="Route state"
                        value="Presence Infrastructure route failure captured"
                        copy="The interruption happened on the one-time improvement page, not necessarily across the full system."
                    />
                    <ReadoutCard
                        label="Best next move"
                        value="Retry once, then step back cleanly"
                        copy="If the page does not recover immediately, return to Visibility Blueprint or Plans instead of forcing a broken improvement layer."
                    />
                    <ReadoutCard
                        label="Reference"
                        value={reference}
            ...
            <section className="relative z-10 mt-20">
                <div className="max-w-3xl">
                    ...
                    <h2 className="mt-4 text-3xl font-semibold tracking-tight text-white sm:text-4xl md:text-5xl">
                        Use the cleanest route back into the improvement path.
                    </h2>
                </div>
                        ...
                        item.type === "retry" ? (
                            <ActionCard
                                ...
                                action={
                                    ...
                                    >
                                        Retry Presence Infrastructure route
                                    </button>
                                }
                            />
                        ) : (
                ...
                <div className="system-panel-authority rounded-[2rem] p-6 sm:p-8 md:p-10">
                    <div className="grid gap-8 lg:grid-cols-[1.08fr_0.92fr] lg:items-center">
                        <div>
                            ...
                            <h2 className="mt-5 max-w-4xl text-3xl font-semibold tracking-tight text-white sm:text-4xl md:text-5xl">
                                Do not make the improvement decision from a broken Presence Infrastructure page.
                            </h2>
                            ...
                            <p className="mt-6 max-w-3xl text-base leading-8 text-slate-300">
                                ...
                                heavier step through a broken or unstable layer.
                            </p>
...
function OptimizationErrorAtmosphere() {
    return (
