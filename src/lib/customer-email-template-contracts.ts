...
export const CUSTOMER_EMAIL_TEMPLATE_CONTRACTS = [
  ...
  },
  {
    ...
    preheader: "Your deeper review is in your dashboard and attached as an approved PDF report.",
    ...
    conversionRole: "Moves from review to implementation by explaining causes, priorities, and Build Fix fit.",
    tone: ["luxury", "calm", "proof-first", "strategic"],
