...
export const PRESENCE_REPORT_ROUTE_BOUNDARIES = {
  public: "Public pages can explain the product path, but sample report pages are no longer part of the public website.",
  protected: "Protected report routes can show customer-specific first signal output after verified access.",
  excluded: "Checkout, login, API, sample report, and internal operator routes must stay out of the public Presence Report route map.",
} as const;
