export const COMPLETE_PLAN_FULFILLMENT_MATRIX = {
  ...
  valueArchitecture: [
    ...
    "Value must be created through truthful review, customer education, premium presentation, useful artifacts, and plan-appropriate action—not through inflated claims or pressure.",
  ],
  ...
  planBoundaryRules: [
    "Free Scan may educate and point to likely next steps, but must not include the full review depth, implementation plan, or recurring control reserved for paid plans.",
    "Deep Review may provide evidence-backed review depth and priority clarity, but must not include done-for-you implementation that belongs to Build Fix.",
  ...
  planMatrix: [
    {
      ...
      planBoundary: "Does not include full review depth, implementation plan, or recurring monitoring.",
      conversionMethod: "Recommend Deep Review only when evidence or uncertainty justifies deeper review.",
    },
    {
      planKey: "deep-review",
      valuePromise: "A fuller evidence-backed review that turns signals into priority, confidence, and next action clarity.",
