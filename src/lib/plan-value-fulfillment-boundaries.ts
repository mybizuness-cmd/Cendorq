...
export const PLAN_VALUE_FULFILLMENT_BOUNDARIES = [
  {
    ...
    customerFacingSummary: "Free Scan delivers the first visible signal and next best move, not a full review or implementation plan.",
    escalationRule: "Escalate to Deep Review when the customer needs cause-level review before spending on fixes or ads.",
  },
  {
    planKey: "deep-review",
    ...
    customerFacingSummary: "Deep Review delivers cause-level review and decision clarity, not implementation work.",
    escalationRule: "Escalate to Build Fix only when the review identifies a scoped improvement ready for implementation.",
  },
  {
    planKey: "build-fix",
    planName: "Build Fix",
    ...
    customerFacingSummary: "Build Fix delivers scoped improvement work, not a full review or recurring monitoring.",
...
export const PLAN_VALUE_FULFILLMENT_RULES = [
  ...
  "Free Scan fulfillment must not produce full review, implementation, or monthly monitoring deliverables.",
