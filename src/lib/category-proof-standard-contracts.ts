...
export const CATEGORY_PROOF_STANDARD_CONTRACTS: readonly CategoryProofStandardContract[] = [
  {
    ...
    confidenceRules: ["mark as sampled signal", "source label required", "confidence label required", "cite visible public source", "label missing access as limitation", "do not infer full index coverage from one page"],
  ...
  },
  {
    ...
    confidenceRules: ["prefer visible text over hidden metadata", "source label required", "confidence label required", "separate unclear copy from missing proof", "state when page context is insufficient"],
  ...
  },
  {
    ...
    confidenceRules: ["do not treat private proof as public proof", "source label required", "confidence label required", "label unverified claims", "require operator approval for proof claims"],
  ...
  },
  {
    ...
    confidenceRules: ["comparison signals require review", "source label required", "confidence label required", "avoid competitor accusations", "explain basis and limits", "use may/might when evidence is partial"],
  ...
  },
  {
    ...
    confidenceRules: ["test mobile first", "source label required", "confidence label required", "separate public and protected language", "state when live access is not wired"],
  ...
  },
  {
    ...
    confidenceRules: ["control is monitoring not guarantee", "source label required", "confidence label required", "state sampling boundary", "separate internal audit from customer-safe note"],
