export const CUSTOMER_EMAIL_CONFIRMATION_HANDOFF_CONTRACT = {
  ...
  operatingStandard: [
    ...
    "After Free Scan or paid intake submission, show a calm check-your-inbox gate instead of revealing protected report results before email verification.",
  ...
  journeyDestinations: [
    {
      ...
      preVerificationScreen: "Check your inbox to confirm your email and unlock your Free Scan result inside your Cendorq dashboard.",
      ...
      reportVisibilityRule: "Do not show Free Scan findings before email verification and safe release state. After verification, show the report state in the dashboard/report vault and send the report email when release rules allow.",
    },
    {
      key: "deep-review-purchased-or-submitted",
      customerMoment: "Customer buys or submits Deep Review intake.",
      preVerificationScreen: "Confirm your email so Cendorq can protect your diagnostic report, send status updates, and open your command center.",
    ...
    },
    {
      ...
      preVerificationScreen: "Confirm your email so optimization scope, approvals, and delivery notes stay connected to your command center.",
      ...
      reportVisibilityRule: "Show optimization scope, required approvals, and delivery status without exposing a standalone Deep Review report unless Deep Review entitlement exists.",
    },
    {
      key: "ongoing-control-started",
      customerMoment: "Customer starts Ongoing Control / Monthly.",
      preVerificationScreen: "Confirm your email so monthly command summaries, change alerts, and approval requests can reach you safely.",
    ...
    },
    {
      ...
      preVerificationScreen: "Confirm your email so Cendorq can route you back to the right private account area.",
  ...
  emailDeliverabilityRules: [
    "The verification email should be transactional, plain, recognizable, low-link-density, and sent from the approved Cendorq sender identity.",
  ...
  releaseRules: [
    "Every intake completion path must define a pre-verification screen, verification email CTA, verified destination, dashboard module, and report visibility rule.",
    ...
    "Release-captain review must reject verification flows that reveal protected results before verification or replace lifecycle email orchestration with dashboard-only messaging.",
  ],
} as const;
