...
export const CENDORQ_PLAN_PRICES = [
  {
    ...
    primaryCustomerPromise: "Find the first visible reason AI engines or customers may misunderstand the business before spending on the wrong fix.",
  ...
  },
  {
    ...
    primaryCustomerPromise: "Get evidence on why AI engines and customers may not understand, trust, or choose the business yet.",
