...
export const CENDORQ_REVENUE_OPERATING_SYSTEM = [
  {
    ...
    nextBestAction: "Continue the Free Scan or start Deep Review when the cause is not clear enough to improve yet.",
  },
  {
    key: "paid-review",
    ...
    price: "$497",
    businessPurpose: "Convert uncertainty into an evidence-backed review before the customer buys improvements, ads, or redesign work.",
    ...
    dashboardState: "Deep Review unlocked with report status, required context, evidence progress, billing record, and report vault destination.",
    backendWorkflow: "Create Deep Review order, entitlement, review queue item, evidence checklist, report shell, notification, and kickoff email.",
    requiredCustomerContext: [
    ...
    emailMoment: "Deep Review is confirmed. Confirm the focus so the review can begin.",
    nextBestAction: "Confirm the review focus and track report progress in the dashboard.",
  },
  {
    key: "paid-repair",
    customerName: "Improve what costs choices",
    planName: "Build Fix",
    price: "$1,497",
    ...
    dashboardState: "Build Fix unlocked with fix intake, current priority, approved business details, support route, and delivery progress.",
    backendWorkflow: "Create Build Fix order, entitlement, fix workspace, asset/context checklist, owner task, notification, and kickoff email.",
    requiredCustomerContext: [
    ...
    emailMoment: "Build Fix is confirmed. Confirm the target, offer, and approved details.",
  ...
  },
  {
    ...
    price: "$597/month",
    businessPurpose: "Create recurring revenue by keeping visibility, trust, readiness, customer friction, and revenue movement under monthly watch.",
    customerFeeling: "Cendorq is helping watch the business with me, not leaving me after one report or fix.",
