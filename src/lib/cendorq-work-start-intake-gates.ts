...
export const CENDORQ_WORK_START_GATES: readonly CendorqWorkStartGate[] = [
  ...
  },
  {
    ...
    customerPromise: "Cendorq can begin Ongoing Control only after there is a baseline review, supported review, or prior fix history plus a monthly priority.",
    requiredBeforeQueue: ["baseline review, supported review, or prior fix history", "approved monthly control baseline", "monthly priority", "channels to watch", "competitor set", "reporting preference", "approval contact"],
