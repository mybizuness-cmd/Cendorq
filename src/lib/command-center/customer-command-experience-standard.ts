...
export const CUSTOMER_COMMAND_EXPERIENCE_RULES = [
  ...
  },
  {
    ...
    area: "conversion",
    requirement: "Every dashboard state must show the most truthful next best action: Free Scan to Deep Review, Deep Review to Build Fix, Build Fix to Ongoing Control, and Ongoing Control to retention or expansion.",
...
export const CUSTOMER_COMMAND_EXPERIENCE_ZONES = [
  ...
  },
  {
    ...
    conversionRole: "Builds confidence and makes deeper review feel necessary when limits are visible.",
  },
  {
    ...
    conversionRole: "Shows why Build Fix or Ongoing Control is the natural next step.",
  },
  {
