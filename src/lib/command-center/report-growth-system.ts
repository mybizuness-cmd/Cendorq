...
export const PLAN_REPORT_DEPTH_RULES = [
  ...
  },
  {
    ...
    depthStandard: "AI Readiness Review must be thorough and extensive: it should verify root causes, explore the business model, website, profiles, reviews, social and platform activity, conversion paths, revenue paths, category context, competitive context, technical blockers, trust gaps, and priority severity.",
    conversionStandard: "It should promote Signal Repair by proving which issues matter most, why they matter commercially, what repair work is required, and why implementation is the logical next step, without lying, exaggerating, or creating anything false.",
    ...
    blockedBehavior: ["shallow review", "unsupported repair recommendation", "invented urgency", "ranking issues without evidence", "overlooking social or platform revenue"],
  },
  {
    planStage: "build-fix",
    depthStandard: "Signal Repair reporting must translate review into action: it should show approved repairs, implementation sequence, expected outcome type, confidence, evidence, constraints, and what remains unverified.",
    conversionStandard: "It should promote Readiness Control by showing why measurement, iteration, regression prevention, platform monitoring, and compounding improvements matter after implementation.",
    requiredSections: ["approved Signal Repair scope", "issue-to-repair mapping", "implementation sequence", "expected outcome type without guarantee", "measurement baseline", "recommended Readiness Control path"],
    blockedBehavior: ["repairs not tied to review", "guaranteed ROI", "ignoring measurement", "claiming implementation alone creates permanent growth"],
  },
  {
    planStage: "ongoing-control",
    depthStandard: "Readiness Control reporting must monitor progress with comparable baselines, platform changes, social and search activity, trust signals, conversion friction, open work, regressions, and next actions.",
