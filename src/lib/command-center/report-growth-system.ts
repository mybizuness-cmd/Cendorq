...
export const PLAN_REPORT_DEPTH_RULES = [
  ...
  },
  {
    ...
    depthStandard: "Ongoing Control reporting must monitor progress with comparable baselines, platform changes, social and search activity, trust signals, conversion friction, open work, regressions, and next actions.",
