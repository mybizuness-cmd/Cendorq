...
export const COMMAND_CENTER_VALIDATION_REGISTRY = [
  ...
  {
    key: "pricing-checkout-orchestration",
    label: "Pricing checkout orchestration",
    scriptPath: "src/scripts/validate-pricing-checkout-orchestration.mjs",
    category: "route",
    requiredInValidateRoutes: true,
    protectedBoundary: "plan prices, checkout metadata, success paths, post-payment emails, report triggers, and post-payment service sequence stay aligned with the customer readiness path",
    failureMeaning: "Pricing, checkout, report triggers, or post-payment activation may have drifted from the customer plan sequence or safe fulfillment model.",
  },
  {
    key: "billing-checkout-contracts",
    label: "Billing checkout contracts",
    scriptPath: "src/scripts/validate-billing-checkout-contracts.mjs",
    category: "security",
    requiredInValidateRoutes: true,
    protectedBoundary: "webhook/idempotent fulfillment, entitlement projection, provider-authoritative billing documents, safe PDF document delivery, billing recovery, and no client-only paid access",
    failureMeaning: "Billing or checkout may be exposing unsafe access, skipping webhook verification, drifting from safe PDF delivery, creating duplicate fulfillment, or allowing billing/report documents without proper authority and gates.",
  },
  {
    key: "dashboard-action-inbox",
    label: "Dashboard action inbox",
    scriptPath: "src/scripts/validate-dashboard-action-inbox.mjs",
    category: "cockpit",
    requiredInValidateRoutes: true,
    protectedBoundary: "dashboard conversion inbox, proof-first paid-depth path, money-surface reentry, verify-to-view, deliverability posture, dashboard-message mirror, and safe PDF attachment policy",
    failureMeaning: "The dashboard may no longer function as the proof-first conversion command room or may have lost mirrored-message, deliverability, safe-document, or plan-depth guardrails.",
  },
  {
    key: "plan-delivery-orchestration-contracts",
    label: "Plan delivery orchestration contracts",
    scriptPath: "src/scripts/validate-plan-delivery-orchestration-contracts.mjs",
    category: "ai",
    requiredInValidateRoutes: true,
    protectedBoundary: "plan delivery boundaries, category-defining report presentation, post-payment service sequence, stage-targeted retargeting, continuous nurturing, future-feature relevance, and report-vault/download parity",
    failureMeaning: "Plan delivery, report presentation, stage targeting, future-feature nurturing, or vault/download parity may have drifted from the customer-owned readiness lifecycle.",
  },
  {
  ...
  },
  {
    ...
    category: "docs",
    requiredInValidateRoutes: true,
    protectedBoundary: "discoverable standards, customer delivery source-of-truth files, safe-document doctrine, dashboard-message mirror doctrine, and guardrail validators",
    failureMeaning: "The private documentation index no longer points operators to required standards, delivery contracts, safe-document rules, or guards.",
  },
  {
    ...
    category: "docs",
    requiredInValidateRoutes: true,
    protectedBoundary: "owner-level evidence accuracy, tailored plan fit, conversion moat, market learning, vault-first access, deliverability posture, safe PDFs, dashboard message mirroring, launch review, and post-build operating cadence",
    failureMeaning: "The owner operating manual no longer preserves the highest-level evidence-backed operating direction or has drifted toward unsafe guarantees or single-channel delivery.",
  },
  {
