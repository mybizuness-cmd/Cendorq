...
expect("CHANGELOG.md", ["# Changelog", "## Unreleased", "Route and link integrity checklist", "PR template route and link integrity gate", "route/link impact", "Offer integrity checklist", "PR template offer integrity gate", "offer-integrity impact", "Lead intake checklist", "PR template lead intake gate", "lead-intake impact", "Visual quality checklist", "PR template visual quality gate", "visual-quality impact", "Conversion quality checklist", "PR template conversion quality gate", "conversion-quality impact", "Observability and diagnostics checklist", "Deployment environment checklist", "Dependency checklist", "Privacy and data handling checklist", "Copy quality checklist", "Accessibility checklist", "Performance checklist", "Search discovery checklist", "Free Scan", "Deep Review", "Build Fix", "Ongoing Control"], "CHANGELOG.md is missing required release-history detail");
expect(".github/pull_request_template.md", ["Buyer-path impact", "Route and link integrity check", "docs/route-link-integrity-checklist.md", "No route/link checklist is needed", "Offer integrity check", "docs/offer-integrity-checklist.md", "No offer integrity checklist is needed", "Lead intake check", "docs/lead-intake-checklist.md", "No lead intake checklist is needed", "Visual quality check", "docs/visual-quality-checklist.md", "No visual quality checklist is needed", "Conversion quality check", "docs/conversion-quality-checklist.md", "No conversion quality checklist is needed", "Release history check", "CHANGELOG.md", "route/link integrity", "offer integrity", "lead intake", "visual quality", "conversion quality", "pnpm validate:routes", "pnpm smoke:production", "Free Scan"], "Pull request template is missing required route/link gate detail");
