...
const checklistExpectations = [
  ["docs/manual-qa-acceptance-checklist.md", ["Cendorq Manual QA and Acceptance Checklist", "Manual QA principle", "Required checks", "Browser and viewport checks", "Buyer-path walkthrough", "Regression checks", "Acceptance criteria checks", "pnpm validate:routes", "pnpm smoke:production", "Free Scan", "post-change signoff"]],
  ["docs/content-freshness-checklist.md", ["Cendorq Content Freshness Checklist", "Content freshness principle", "Required checks", "Stale-label checks", "Screenshot and example checks", "Plan and offer freshness checks", "Release-history checks", "pnpm validate:routes", "pnpm smoke:production", "Free Scan", "Visibility Blueprint"]],
  ["docs/configuration-safety-checklist.md", ["Cendorq Configuration Safety Checklist", "Configuration principle", "Required checks", "Environment variable checks", "Public/private config checks", "Drift checks", "Failure-state checks", "pnpm validate:routes", "pnpm smoke:production", "Free Scan", "hardcoded credentials"]],
  ["docs/integration-readiness-checklist.md", ["Cendorq Integration Readiness Checklist", "Integration principle", "Required checks", "API handoff checks", "Payment and checkout checks", "AI service checks", "Email, CRM, and notification checks", "pnpm validate:routes", "pnpm smoke:production", "Free Scan", "hardcoded credentials"]],
  ["docs/analytics-tracking-checklist.md", ["Cendorq Analytics and Tracking Checklist", "Analytics principle", "Required checks", "Event naming checks", "Script and pixel checks", "Privacy checks", "Buyer-path measurement checks", "pnpm validate:routes", "pnpm smoke:production", "Free Scan", "hidden tracking"]],
...
expect("CHANGELOG.md", ["# Changelog", "## Unreleased", "Manual QA and acceptance checklist", "PR template manual QA and acceptance gate", "manual-QA impact", "Content freshness checklist", "Configuration safety checklist", "Integration readiness checklist", "Analytics and tracking checklist", "Policy and legal surface checklist", "Trust and credibility checklist", "Route and link integrity checklist", "Offer integrity checklist", "Lead intake checklist", "Free Scan", "Deep Review", "Build Fix", "Ongoing Control"], "CHANGELOG.md is missing required release-history detail");
expect(".github/pull_request_template.md", ["Buyer-path impact", "Manual QA and acceptance check", "docs/manual-qa-acceptance-checklist.md", "No manual QA checklist is needed", "Content freshness check", "docs/content-freshness-checklist.md", "Configuration safety check", "docs/configuration-safety-checklist.md", "Release history check", "CHANGELOG.md", "manual QA", "content freshness", "configuration safety", "pnpm validate:routes", "pnpm smoke:production", "Free Scan"], "Pull request template is missing required manual QA gate detail");
