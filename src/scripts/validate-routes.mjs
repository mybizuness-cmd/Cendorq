...
expectFileToInclude("CHANGELOG.md", ["# Changelog", "## Unreleased", "Accessibility checklist", "PR template accessibility gate", "Release note format", "buyer-path impact", "production-safety impact", "accessibility impact", "validation completed", "PR template release-history gate", "Free Scan", "Deep Review", "Build Fix", "Ongoing Control"], "CHANGELOG.md is missing required release-history detail");
...
expectFileToInclude("docs/release-checklist.md", ["Cendorq Release Checklist", "docs/incident-response.md", "docs/accessibility-checklist.md", "CHANGELOG.md", "accessibility", "Pre-merge checklist", "Merge checklist", "Post-deploy checklist", "Rollback checklist", "Release notes standard", "pnpm validate:routes", "pnpm smoke:production", "Free Scan", "https://cendorq.com"], "Release checklist is missing required deployment detail");
...
expectFileToInclude(".github/pull_request_template.md", ["Buyer-path impact", "Conversion check", "Accessibility check", "docs/accessibility-checklist.md", "No accessibility checklist is needed", "Production safety check", "Release history check", "CHANGELOG.md", "meaningful production", "accessibility", "No changelog update is needed", "pnpm validate:routes", "pnpm smoke:production", "Free Scan", "Ongoing Control"], "Pull request template is missing required quality gate detail");
expectFileToInclude("README.md", ["Cendorq", "CHANGELOG.md", "release history", "docs/accessibility-checklist.md", "accessibility checks", "Free Scan", "Deep Review", "Build Fix", "Ongoing Control", "docs/production-guide.md", "docs/release-checklist.md", "docs/incident-response.md", "pnpm validate:routes", "pnpm smoke:production", "Node 24", "pnpm 9.15.9", ".env.example", ".editorconfig", ".gitattributes", "runs automatically every day"], "README is missing required production entry guidance");
