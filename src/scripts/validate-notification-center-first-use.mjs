...
expect(pagePath, [
  ...
  "Ready alerts should lead to proof before checkout, support status before duplicates, and secure access before account context.",
  "Priority AI Visibility feed",
  "Scan. Review. Repair. Control. One safe next action each.",
  "Every signal should point to proof, access, status, or safe recovery before it sends the customer deeper.",
