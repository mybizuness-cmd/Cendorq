...
const validatorPath = "src/scripts/validate-customer-support-status-contracts.mjs";
...
console.log("Customer support status contracts validation passed with owner posture, support records, support API, and route-chain coverage.");
