...
if (!failures.length) {
  ...
  validateTextFile("src/lib/platform-interface-excellence-contracts.ts", [
  ...
  validateTextFile("src/lib/seamless-responsive-sync-contracts.ts", [
  ...
  validateTextFile("src/lib/core-information-protection-contracts.ts", [
  ...
  validateTextFile("src/lib/institutional-operating-maturity-contracts.ts", [
  ...
  validateTextFile("src/lib/adversarial-validation-suite-contracts.ts", [
  ...
  validateTextFile("src/lib/observability-incident-response-contracts.ts", [
  ...
  validateTextFile("src/lib/backup-disaster-recovery-contracts.ts", [
  ...
  validateTextFile("src/app/dashboard/page.tsx", [
    "OPERATING_SNAPSHOT",
  ...
  validateTextFile("src/app/page.tsx", [
    ...
    "Proof before pressure",
    "No fake urgency",
    "Protected dashboard/report vault",
  ]);

  validateTextFile("src/app/free-check/page.tsx", [
  ...
  validateTextFile("src/lib/command-center/validation-registry.ts", [
    "controlled-maintenance",
    "Controlled maintenance",
    "src/scripts/validate-controlled-maintenance-contracts.mjs",
  ...
  validateTextFile("src/lib/command-center/enterprise-operating-standard.ts", [
    "Enterprise operating standard",
    "Liability minimization defense",
    "Audit defense pass",
  ]);

  validateTextFile("src/lib/command-center/audit-defense-system.ts", [
  ...
  for (const validatorPath of requiredValidators) {
    validateTextFile(validatorPath, [validatorPath.split("/").pop()]);
  }
