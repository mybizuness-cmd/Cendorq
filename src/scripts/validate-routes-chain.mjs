...
console.log(`\nvalidate:routes chain passed baseline route existence, release-control workflow coverage, CodeQL workflow integrity coverage, dependency lockfile integrity coverage, repo update scanning automation coverage, command design standard coverage, public drift coverage, maximum-protection coverage, owner maximum-protection posture coverage, closed-intelligence coverage, owner operating manual coverage, command-center docs-index coverage, command-center core validation-registry coverage, report truth/evidence orchestration runtime/panel/API coverage, report evidence record runtime/persistence/panel/API coverage, report generation/rendering and protected Free Scan results rendering coverage, Cendorq agent intelligence playbook coverage, agent mission operating engine, records runtime, review gates runtime, live execution runtime, plan-trigger wiring, finding submission runtime, and chief review runtime coverage, owner configuration smoke coverage, customer platform/experience coverage, active Free Scan form selection coverage, and Free Scan routing hint wire contract coverage for the customer revenue/access flow.`);
