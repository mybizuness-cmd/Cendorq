...
const validators = [
  ...
  "src/scripts/validate-video-source-handoff-index.mjs",
  ...
  "src/scripts/validate-customer-access-redirect-hardening.mjs",
  ...
  "src/scripts/validate-customer-email-provider-dispatch-adapter.mjs",
  "src/scripts/validate-customer-email-provider-configuration-contracts.mjs",
  "src/scripts/validate-customer-email-provider-send-interface.mjs",
  "src/scripts/validate-customer-email-dispatch-audit-runtime.mjs",
