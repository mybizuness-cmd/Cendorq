...
const expectedPanels = [
  ...
  ["OperatorExecutionContractsPanel", "operator-execution-contracts"],
  ["OwnerReportTestModePanel", "owner-report-test-mode"],
  ["ReportQualityDominationPanel", "report-quality-domination"],
