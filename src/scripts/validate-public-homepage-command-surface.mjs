...
check("src/components/homepage/homepage-clarity-reset.tsx", ["final-master-presence-product-film", "Know why customers choose someone else.", "Run Free Scan", "See Sample Report", "Search Presence", "Choice Gap", "Repair Queue", "Presence Report in motion"]);
check("src/components/homepage/cendorq-3d-presence-command.tsx", ["final-master-presence-command-center", "After the scan", "The owner sees the problem", "Presence Report", "Choice Gap", "Repair Queue", "Control"]);
check("src/layout/site-header-conversion.tsx", ["Product", "Sample Report", "Plans", "FAQ", "Contact", "Customer Access", "Start Free Scan", "href=\"/sample-report\"", "href=\"/plans\"", "href=\"/faq\"", "href=\"/connect\"", "href=\"/login\""]);
...
maxLength("src/components/homepage/cendorq-3d-presence-command.tsx", 12000);
...
console.log("Public command surface validation passed with cinematic product story, simplified command outcomes, active buyer routes, and current Cendorq terminology.");
