...
const CTA_CLASS =
  "inline-flex min-h-10 shrink-0 items-center justify-center rounded-full border border-slate-950 bg-white px-3 py-2 text-sm font-semibold text-slate-950 shadow-[inset_0_0_0_1px_rgba(15,23,42,0.08),0_8px_24px_rgba(15,23,42,0.08)] transition duration-200 hover:border-slate-700 hover:bg-slate-50 hover:text-slate-950 focus:outline-none focus-visible:ring-2 focus-visible:ring-slate-950 focus-visible:ring-offset-2 sm:min-h-11 sm:px-5 sm:py-2.5";
...
export function SiteHeader() {
  return (
    <header className="sticky top-0 z-50 w-full overflow-hidden border-b border-slate-200 bg-white/95 text-slate-950 backdrop-blur-xl">
      ...
      <span className="sr-only">Logo links to the Cendorq homepage. Mobile navigation keeps Plans, Sign in, and Scan visible without clipping AI Readiness. href="/login"</span>
    </header>
  );
}
