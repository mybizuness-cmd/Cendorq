...
This checklist protects future report delivery, email follow-up, CRM sync, webhook channels, support handoff, and automation handoff before live sends are enabled.

## Principle

Cendorq remains the source of truth. Delivery tools are channels, not the core system.

Email services, CRM tools, GoHighLevel, Zapier, webhook systems, support channels, and automation platforms must remain swappable.
...
Before live report delivery or live Contact Us send handling is enabled, the system must support:
...
- No fake Contact Us support records to make tests pass.
